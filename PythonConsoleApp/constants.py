...
class Constants:
    ...
    def load_from_env():
        ...
        Constants.unrefined_ore_weight = int(os.getenv("unrefined_ore_weight"))
        Constants.refined_ore_weight = int(os.getenv("refined_ore_weight"))
        Constants.unrefined_ore_cost = int(os.getenv("unrefined_ore_cost"))
        Constants.refined_ore_cost = int(os.getenv("refined_ore_cost"))
        Constants.invalid_turn_energy_penalty = int(os.getenv("invalid_turn_energy_penalty"))
        Constants.mining_energy_loss = int(os.getenv("mining_energy_loss"))
        ...
        Constants.cheep_ore_symbol = os.getenv("cheep_ore_symbol")
        Constants.expensive_ore_symbol = os.getenv("expensive_ore_symbol")
        Constants.refinement_facility_symbol = os.getenv("refinement_facility_symbol")
        Constants.number_of_cheap_ores = int(os.getenv("number_of_cheap_ores"))
        Constants.number_of_expensive_ores = int(os.getenv("number_of_expensive_ores"))
